...
public class CollectingTest {
    ...
    public void testAverageScoresPerTask() {
        ...
        Map<String, Double> received1 = new Collecting().averageScoresInTask(programmingResults(new Random(969)));
        ...
        Map<String, Double> received2 = new Collecting().averageScoresInTask(programmingResults(new Random(654)));
        ...
        Map<String, Double> received3 = new Collecting().averageScoresInTask(historyResults(new Random(853)));
        ...
        Map<String, Double> received4 = new Collecting().averageScoresInTask(historyResults(new Random(753)));
